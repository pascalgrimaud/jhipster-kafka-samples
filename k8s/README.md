...
```
$ docker image tag hipsreader pascalgrimaud/hipsreader
$ docker push pascalgrimaud/hipsreader
$ docker image tag hipswriter pascalgrimaud/hipswriter
$ docker push pascalgrimaud/hipswriter
```
...
```
$ kubectl get svc hipsreader
$ kubectl get svc hipswriter
```
